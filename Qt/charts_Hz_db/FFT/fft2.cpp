  ...
  sintabinv_data[], int sintabinv_size[2])
{
  ...
  nd2 = n / 2 - 1;
  for (k = 0; k <= nd2; k++) {
    costab1q_data[1 + k] = std::cos(e * (1.0 + static_cast<double>(k)));
  }
  ...
  if (!useRadix2) {
    i0 = n << 1;
    costab_size[0] = 1;
    costab_size[1] = static_cast<short>((i0 + 1));
    sintab_size[0] = 1;
    sintab_size[1] = static_cast<short>((i0 + 1));
    costab_data[0] = 1.0;
    sintab_data[0] = 0.0;
    sintabinv_size[0] = 1;
    sintabinv_size[1] = static_cast<short>((i0 + 1));
    for (k = 0; k < n; k++) {
    ...
    nd2 = n << 1;
    costab_size[0] = 1;
    costab_size[1] = static_cast<short>((nd2 + 1));
    sintab_size[0] = 1;
    sintab_size[1] = static_cast<short>((nd2 + 1));
    costab_data[0] = 1.0;
    sintab_data[0] = 0.0;
    for (k = 0; k < n; k++) {
      costab_data[1 + k] = costab1q_data[1 + k];
