...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	lwipx->netmask[0]=NETMASK_ADDR0;	
	lwipx->netmask[1]=NETMASK_ADDR1;
	lwipx->netmask[2]=NETMASK_ADDR2;
	lwipx->netmask[3]=NETMASK_ADDR3;
	//默认网关:192.168.1.1
	lwipx->gateway[0]=GW_ADDR0;	
	lwipx->gateway[1]=GW_ADDR1;
	lwipx->gateway[2]=GW_ADDR2;
	lwipx->gateway[3]=GW_ADDR3;
